...
<body>
    <div id="wrapper">
        ...
        <button class="button" style="vertical-align:middle" onclick="window.location.href='/app/register.php'">
            <span>Register </span></button>
        <br>
        <button class="button" style="vertical-align:middle" onclick="window.location.href='/app/login.php'">
